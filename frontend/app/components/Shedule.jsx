  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await fetchWithAuth(
        "https://nothypeproduction.space/api/v1/conference/create",
        {
          method: "POST",
          headers: {
  ...
  return (
    <>
      ...
      <div
        ...
        id="cb"
      >
        <h2 style={{ color: "gray", marginTop: "20px" }}>Мои конференции</h2>
      </div>
      <MyConference />
      <div
        style={{
      ...
      {showModal && (
        <div
          className={styles.classes_create_class_box}
          ref={menuRef}
        ...
        >
          ...
          <div style={{ display: "flex", width: "70%", margin: "auto" }}>
            <input
              className={styles.classes_create_date}
              type="datetime-local"
              value={time}
